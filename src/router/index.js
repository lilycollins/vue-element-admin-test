...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'deviceCheck',
        component: () => import('@/views/fire/deviceCheck.vue'),
        name: 'deviceCheck',
        meta: { title: '消防设备巡检计划' }
      },
      {
      ...
      {
        path: 'history',
        component: () => import('@/views/fire/history.vue'),
        name: 'history',
        meta: { title: '历史记录查询' }
      },
      {
  ...
  },
  {
    ...
    children: [
      {
        path: 'protectThing',
        component: () => import('@/views/fix/protectThing.vue'),
        name: 'protectThing',
        meta: { title: '保修事件' }
      },
      {
      ...
      {
        path: 'fixManifest',
        component: () => import('@/views/fix/fixManifest.vue'),
        name: 'fixManifest',
        meta: { title: '维修工单' }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'preApply',
        component: () => import('@/views/consume/preApply.vue'),
        name: 'preApply',
        meta: { title: '耗材预申请' }
      },
      {
        path: 'getRecord',
        component: () => import('@/views/consume/getRecord.vue'),
        name: 'getRecord',
        meta: { title: '耗材领用记录' }
      },
      {
        path: 'consumeType',
        component: () => import('@/views/consume/consumeType.vue'),
        name: 'consumeType',
        meta: { title: '耗材类型' }
      },
      {
        path: 'consumeInfo',
        component: () => import('@/views/consume/consumeInfo.vue'),
        name: 'consumeInfo',
        meta: { title: '耗材信息' }
      },
      {
        path: 'supplier',
        component: () => import('@/views/consume/supplier.vue'),
        name: 'supplier',
        meta: { title: '供应商管理' }
      },
      {
        path: 'apply',
        component: () => import('@/views/consume/apply.vue'),
        name: 'apply',
        meta: { title: '耗材申请' }
      },
      {
        path: 'storage',
        component: () => import('@/views/consume/storage.vue'),
        name: 'storage',
        meta: { title: '耗材库存查询' }
      },
      {
        path: 'instore',
        component: () => import('@/views/consume/instore.vue'),
        name: 'instore',
        meta: { title: '耗材入库' }
      },
      {
        path: 'outstore',
        component: () => import('@/views/consume/outstore.vue'),
        name: 'outstore',
        meta: { title: '耗材出库' }
      },
      {
        path: 'inventory',
        component: () => import('@/views/consume/inventory.vue'),
        name: 'inventory',
        meta: { title: '耗材盘点' }
      },
      {
        path: 'fixInventory',
        component: () => import('@/views/consume/fixInventory.vue'),
        name: 'fixInventory',
        meta: { title: '耗材盘点修正' }
      },
      {
        path: 'countAnalysis',
        component: () => import('@/views/consume/countAnalysis.vue'),
        name: 'countAnalysis',
        meta: { title: '统计分析' }
      },
      {
        path: 'bi',
        component: () => import('@/views/consume/bi.vue'),
        name: 'bi',
        meta: { title: '报表管理' }
      },
      {
        path: 'applyAudit',
        component: () => import('@/views/consume/applyAudit.vue'),
        name: 'applyAudit',
        meta: { title: '耗材申请审核' }
      }
    ]
